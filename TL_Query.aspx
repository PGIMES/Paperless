<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TL_Query.aspx.cs" Inherits="TL_Query" Theme="menu" %>
				...
				<TBODY>
                                                                                                        ...
                                                                                                        <table width="800">
                                                                                                            <tr>
                                                                                                                <td style="width: 100px">
                                                                                                                    物料编码：</td>
                                                                                                                <td class="style7">
                                                                                                                    <asp:TextBox ID="txt_wlbm" runat="server" Width="100px"></asp:TextBox>
                                                                                                                </td>
                                                                                                                <td style="width: 87px">
                                                                                                                    物料名称：</td>
                                                                                                                <td>
				 ...
				 <td class="style6"> 
                             <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                  Height="99px" 
                         Width="91%" onrowdatabound="GridView1_RowDataBound" AllowPaging="True" 
                                 ...
                                 <Columns>
                                     ...
                                     <asp:TemplateField HeaderText="操作">
                                         <ItemTemplate>
                                             <asp:Button ID="Button3" runat="server" onclick="Button3_Click" Text="退料" />
                                         </ItemTemplate>
                                     </asp:TemplateField>
                                 </Columns>
