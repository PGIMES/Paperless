<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TL_Record.aspx.cs" Inherits="TL_Record"  Theme="menu" %>
...
<script language="javascript" type="text/javascript">
    function deleteConfirm() {
        return window.confirm("确定该笔退料单要关闭吗？");
    }
	</script>
				...
				<TBODY>
																			...
																			<TR>
																				<TD bgColor="#d7dfe8" align="left"><FONT color="#999999"><FONT class="download_from" color="#000000">
                                                                                    <IMG height="25" src="Images/techserv_right_files/arrow-001db.gif" width="22" 
                                                                                        align="absMiddle">退料</FONT><FONT class="download_name3" color="#4d4d4d">记录查询条件</FONT></FONT></TD>
																			</TR>
																		</TABLE>
																...
																<TBODY>
																	<TR>
																		<TD width="75%" align="left"><FONT color="#666666"><IMG height="25" 
                                                                                src="Images/techserv_right_files/arrow-001O.gif" width="22" align="absMiddle"><FONT class="download_name3" face="Ш蔨">退料记录清单
																		</TBODY>
															</TABLE>
														</TD>
													</TR>
				 ...
				 <td class="style6"> 
                     <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                         Width="97%" Height="99px" onrowdatabound="GridView1_RowDataBound">
                         <Columns>
                             <asp:BoundField DataField="tldh" HeaderText="退料单号" />
                             ...
                             <asp:BoundField DataField="Truename" HeaderText="退料人" />
                             <asp:BoundField DataField="create_date" HeaderText="领用日期" />
                             <asp:TemplateField HeaderText="操作">
                                 <ItemTemplate>
                                     <asp:Button ID="Button3" runat="server" onclick="Button3_Click" Text="关闭"   OnClientClick='javascript:return deleteConfirm();'/>
                                 </ItemTemplate>
                             </asp:TemplateField>
                         </Columns>
