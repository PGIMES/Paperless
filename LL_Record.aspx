<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LL_Record.aspx.cs" Inherits="LL_Record" Theme="menu"  EnableEventValidation="false"%>
                                                                                                        ...
                                                                                                        <table width="800">
                                                                                                            <tr>
                                                                                                                <td style="width: 100px">
                                                                                                                    &nbsp;物料编码：</td>
                                                                                                                <td class="style12">
                                                                                                                    <asp:TextBox ID="txt_wlbm" runat="server" Width="150px"></asp:TextBox>
                                                                                                                </td>
                                                                                                                <td style="width: 87px">
                                                                                                                    物料名称：</td>
                                                                                                                <td class="style11">
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                                                                    <asp:Button ID="Button6" runat="server" class="STYLE1" 
                                                                                                                        onclick="Button6_Click" Text="关闭" Width="95px" />
                                                                                                                    &nbsp;</td>
                                                                                                            </tr>
                                                                                                        </table>
                                                                                                    </asp:Panel>
